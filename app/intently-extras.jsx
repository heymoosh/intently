...
const INTEGRATIONS = [
  {
    ...
    Mark: () => <MarkBox><MarkImg src="assets/integrations/gcal.png" alt="Google Calendar" size={38} /></MarkBox>,
  },
  {
  ...
  },
  {
    ...
    Mark: () => <MarkBox><MarkImg src="assets/integrations/gmail.png" alt="Gmail" size={26} /></MarkBox>,
  },
  {
    ...
    Mark: () => <MarkBox><MarkImg src="assets/integrations/slack.webp" alt="Slack" size={26} /></MarkBox>,
  },
  {
    ...
    Mark: () => <MarkBox><MarkImg src="assets/integrations/notion.png" alt="Notion" size={30} /></MarkBox>,
  },
  {
    ...
    Mark: () => <MarkBox><MarkImg src="assets/integrations/github.png" alt="GitHub" size={30} /></MarkBox>,
  },
  // ── Hidden — registered but not shown in the page ──
  { id: 'discord',  name: 'Discord',         group: 'Communication', visible: false, tagline: 'Server activity and DMs.',     pulls: ['DMs', 'Mentions'],                       Mark: () => <MarkBox><MarkImg src="assets/integrations/discord.png" alt="Discord" size={28} /></MarkBox> },
  { id: 'teams',    name: 'Microsoft Teams', group: 'Communication', visible: false, tagline: 'Work chat and meetings.',      pulls: ['Chats', 'Mentions', 'Meeting invites'], Mark: () => <MarkBox><MarkImg src="assets/integrations/teams.png" alt="Microsoft Teams" size={28} /></MarkBox> },
